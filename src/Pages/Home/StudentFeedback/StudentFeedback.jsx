const StudentFeedback = () => {
    return (
        <div className="w-10/12 mx-auto py-20">
            ...
            <div>
                <h2 className="mb-1 text-xl uppercase font-semibold">story about seo</h2>
                <p className="text-lg dark:text-gray-400">He is a highly SEO expert teacher An experienced mentor, and he is a highly professional SEO expert in Bangladesh. Hridoy Chowdury is a Great Man and Best SEO mentor in Bangladesh. Many many love and best wishes for him.</p>
            </div>
            ...
            <div className="flex space-x-4">
                ...
                <div className="flex flex-col space-y-1">
                    <a rel="noopener noreferrer" href="#" className="text-sm font-semibold">Samia Sami</a>
                    <span className="text-xs dark:text-gray-400">4 hours ago</span>
                </div>
            </div>
            ...
            <div>
                <h2 className="mb-1 text-xl uppercase font-semibold">story about seo</h2>
                <p className="text-lg dark:text-gray-400">You are one of the few people in my life whose mind is incomparable.Thank you for your support, advice, love, and prayers. You have been a blessing in my life. God bless you! You are my inspiration. Thank you for being a wonderful friend, teacher, and mentor.</p>
            </div>
            ...
            <div className="flex space-x-4">
                ...
                <div className="flex flex-col space-y-1">
                    <a rel="noopener noreferrer" href="#" className="text-sm font-semibold">Hasibul Hasan</a>
                    <span className="text-xs dark:text-gray-400">4 hours ago</span>
                </div>
            </div>
            ...
            <div>
                <h2 className="mb-1 text-xl uppercase font-semibold">story about seo</h2>
                <p className="text-lg dark:text-gray-400">অসাধারন একজন মেন্টর। যদি আপনি SEO তে ০ লেভেল এ বা জ্ঞান শূন্য থাকেন। তবে আপনার জন্য হৃদয় ভাইয়ের কোর্স বেস্ট চয়েজ বলবো। আমি নিজেই 0 লেভেল নিয়ে কোর্স করছি। এখন মুটামুটি অনেকটা জানি বা বুঝি। তবে একটা কথা, ভালো মেন্টর পেলে হবে না, আপনাকেও একজন পরিশ্রমি মানুষ হতে হবে, তবেই সফল হবেন। আবার আপনি পরিশ্রমি কিন্তু আপনার মেন্টর ভালো না সেক্ষেত্রে ও সফলতা পাওয়া কঠিন।</p>
            </div>
            ...
            <div className="flex space-x-4">
                ...
                <div className="flex flex-col space-y-1">
                    <a rel="noopener noreferrer" href="#" className="text-sm font-semibold">Moshiur Rahman</a>
                    <span className="text-xs dark:text-gray-400">4 hours ago</span>
                </div>
            </div>
